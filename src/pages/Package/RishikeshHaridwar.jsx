// src/pages/destinations/RishikeshHaridwar.jsx
...
import {
  ...
  Sun, // For Season
  Tent,
  Sparkles // For Spirituality/Yoga
} from 'lucide-react';
...
// Data specific to Rishikesh-Haridwar Trip
const tourDetailsData = [
  { icon: Hotel, label: "Accommodation", value: "Hotel / Riverside Camp" },
  { icon: Utensils, label: "Meals", value: "Breakfast & Dinner (Veg)" },
  { icon: Car, label: "Transportation", value: "Private Cab / Tempo" },
  { icon: Users, label: "Group Size", value: "Family / Friends" },
  { icon: Languages, label: "Language", value: "Hindi, English" },
  { icon: Sun, label: "Best Season", value: "Sep to June (Rafting)" },
  { icon: CalendarClock, label: "Duration", value: "4 Days / 3 Nights" },
  { icon: Tent, label: "Category", value: "Adventure & Spiritual" },
  { icon: Sparkles, label: "Experience", value: "Aarti, Yoga & Rafting" },
];
...
// ---------- EXISTING DATA (RISHIKESH - HARIDWAR 4D/3N) ----------

// HERO SLIDES
const heroSlides = [
  {
    image:
      'https://images.unsplash.com/photo-1596021688661-33cb39725f2d?q=80&w=1600&auto=format&fit=crop',
    title: 'Rishikesh & Haridwar Combo',
    subtitle: 'Ganga Aarti • Rafting • Temples',
    days: '4 Days | 3 Nights',
  },
  {
    image:
      'https://images.unsplash.com/photo-1626127027520-2c700cb74432?q=80&w=1600&auto=format&fit=crop',
    title: 'River Rafting & Camping',
    subtitle: 'Adventure in the Yoga Capital',
    days: '4 Days | Customizable',
  },
  {
    image:
      'https://images.unsplash.com/photo-1570802345330-74b0cc112469?q=80&w=1600&auto=format&fit=crop',
    title: 'Har Ki Pauri & Ghats',
    subtitle: 'Spiritual Peace & Evening Vibes',
    days: '4 Days | 3 Nights',
  },
];
...
const exploreLocations = [
  ...
  {
    image:
      'https://i.pinimg.com/1200x/9b/4f/2d/9b4f2d3f3f2d2f3f2d2f3f2d2f3f2d2f.jpg', // Placeholder for Ram Jhula
    title: 'Ram Jhula & Laxman Jhula',
    days: 'Day 2',
  },
  {
    image:
      'https://i.pinimg.com/736x/8a/5a/8a/8a5a8a8a8a8a8a8a8a8a8a8a8a8a8a8a.jpg', // Placeholder for Rafting
    title: 'Shivpuri River Rafting',
    days: 'Day 3',
  },
  {
    image:
      'https://i.pinimg.com/1200x/59/82/32/598232924f0c4084f379204047e13749.jpg', // Placeholder for Beatles Ashram
    title: 'Beatles Ashram & Cafés',
    days: 'Day 2-3',
  },
];
...
const tourHighlights = [
  'Witness the divine Ganga Aarti at Har Ki Pauri (Haridwar) & Parmarth Niketan (Rishikesh).',
  'Thrilling River Rafting (16km/24km) from Shivpuri/Marine Drive.',
  'Camping experience with bonfire, music, and beach volleyball (Shivpuri).',
  'Visit Mansa Devi & Chandi Devi Temples (via Ropeway).',
  'Explore Ram Jhula, Laxman Jhula, and the famous Beatles Ashram.',
  'Visit Neer Gaddu Waterfall and experience café culture in Tapovan.',
  'Comfortable stay in hotels/camps with breakfast & dinner.',
];
...
const itinerary = [
  {
    day: 'Day 01',
    title: 'Arrival in Haridwar – Temples & Aarti',
    description:
      'Pickup, check-in, Mansa Devi Temple & Evening Ganga Aarti.',
    details:
      'Pickup from Delhi/Haridwar Station. Check-in to your hotel in Haridwar. Visit Mansa Devi and Chandi Devi temples (Ropeway ride available). In the evening, witness the mesmerizing Ganga Aarti at Har Ki Pauri. Explore the local market. Dinner & overnight stay in Haridwar.',
  },
  {
    day: 'Day 02',
    title: 'Haridwar → Rishikesh (Sightseeing)',
    description:
      'Transfer to Rishikesh, Ashrams, Jhulas & Triveni Ghat.',
    details:
      'After breakfast, drive to Rishikesh (1 hour). Check-in to hotel/camp. Visit the iconic Ram Jhula and Laxman Jhula. Explore Swarg Ashram, Geeta Bhawan, and The Beatles Ashram (Chaurasi Kutia). In the evening, attend the spiritual Ganga Aarti at Parmarth Niketan or Triveni Ghat. Dinner & overnight stay in Rishikesh.',
  },
  {
    day: 'Day 03',
    title: 'Adventure Day – Rafting & Camping',
    description:
      'River Rafting, Cliff Jumping, Neer Gaddu Waterfall & Campfire.',
    details:
      'Post breakfast, head for the most awaited activity – River Rafting on the Ganges (Shivpuri to Nim Beach). Experience rapids, body surfing, and cliff jumping. Later, hike to Neer Gaddu Waterfall. Evening is free for café hopping in Tapovan or relaxing at your riverside camp with bonfire and music. Dinner & overnight stay.',
  },
  {
    day: 'Day 04',
    title: 'Morning Yoga • Departure',
    description:
      'Optional Yoga session, checkout & return journey.',
    details:
      'Wake up early for a Yoga/Meditation session by the river (optional). After breakfast, check out. Visit Neelkanth Mahadev Temple (optional/time permitting). Start your return journey towards Delhi / Haridwar Station for drop-off. Tour ends with spiritual and adventurous memories.',
  },
];

// INCLUSIONS
const includeFeatures = [
  '3 Nights accommodation (1N Haridwar Hotel + 1N Rishikesh Hotel + 1N Camp).',
  'Daily breakfast & dinner (Buffet/Veg).',
  'Pickup & drop from Delhi / Haridwar by private AC Cab.',
  'River Rafting charges (16km from Shivpuri).',
  'Sightseeing as per itinerary.',
  'Driver night charges, toll taxes, parking & fuel included.',
  'Bonfire and music at the camp (subject to weather).',
];

// EXCLUSIONS
const excludeFeatures = [
  'Train / Flight tickets.',
  'Entry tickets (Beatles Ashram, Ropeway charges).',
  'Lunch and meals not mentioned in inclusions.',
  'Bungee Jumping / Giant Swing / Zipline charges (can be booked extra).',
  'Any personal expenses like pooja samagri, tips, laundry.',
...
const faqs = [
  {
    question: 'Is River Rafting safe for beginners?',
    answer:
      'Yes, absolutely. You are provided with life jackets, helmets, and an expert guide. The Shivpuri stretch (16km) has moderate rapids suitable for beginners and families.',
  },
  {
    question: 'When is Rafting closed?',
    answer:
      'River rafting is usually closed during the monsoon season (July to mid-September). The best time is from October to June.',
  },
  {
    question: 'Can we include Bungee Jumping?',
    answer:
      'Yes, Bungee Jumping at Jumpin Heights can be added. It requires advance booking and an extra day or time management on Day 3. Cost is extra.',
  },
  {
    question: 'Is non-veg food available?',
    answer:
      'Haridwar is a holy city and strictly vegetarian. In Rishikesh town, it is mostly veg. However, some camps and hotels in outer areas/Tapovan may serve non-veg or eggs.',
  },
];
...
const relevantPackages = [
  {
    ...
    title: 'Mussoorie • Rishikesh Combo',
...
// ROUTE COORDS (approx) – Haridwar → Rishikesh → Shivpuri
const routeCoords = [
  [29.9457, 78.1642], // Haridwar
  [30.0869, 78.2676], // Rishikesh
  [30.1360, 78.3880], // Shivpuri (Rafting Point)
];

// ---------- SEPARATE ROUTE MAP COMPONENT ----------

function RishikeshRouteMap() {
...
export default function RishikeshHaridwar() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-blue-50 font-sans">
      ...
      <div className="bg-white shadow-md border-b border-slate-100 relative z-20 -mt-2 sm:mt-0 rounded-t-2xl sm:rounded-none">
        <div className="container mx-auto px-4 py-4 md:py-5 flex flex-wrap gap-x-6 gap-y-3 items-center justify-center lg:justify-between text-xs sm:text-sm md:text-base font-medium text-slate-700">
          ...
          <div className="flex items-center gap-2">
            <CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" />
            <span>Experienced Rafting Guides</span>
          </div>
          <div className="flex items-center gap-2 bg-yellow-50 px-3 py-1 rounded-full">
            <Star className="w-4 h-4 text-yellow-400 fill-yellow-400 shrink-0" />
            <span>
              4.8 / 5 based on <strong>400+ reviews</strong>
            </span>
          </div>
          <div className="hidden sm:flex items-center gap-2">
            <CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" />
            <span>Trusted for Spiritual & Adventure Tours</span>
          </div>
        </div>
      </div>
            ...
            <ScrollReveal>
              <div id="overview">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 text-slate-900">
                  About Rishikesh & Haridwar Tour (4 Days / 3 Nights)
                </h2>
                <p className="text-sm sm:text-base md:text-lg text-slate-600 mb-6 leading-relaxed">
                  Immerse yourself in the perfect blend of spirituality and adventure with our
                  <span className="font-semibold text-blue-700">
                    {' '}Rishikesh & Haridwar Combo Package
                  </span>.
                  From the divine Ganga Aarti at Har Ki Pauri to the thrill of White Water Rafting
                  in Rishikesh, this trip offers a complete rejuvenating experience for your mind and soul.
                </p>
                  ...
                  <div className="p-5 sm:p-6 space-y-4">
                    ...
                    <h3 className="text-xl sm:text-2xl font-bold text-emerald-950 leading-tight">
                      ...
                      <span className="block text-emerald-700 text-lg sm:text-xl mt-1">
                        Build your own Adventure Trip
                      </span>
                    </h3>
                    <ul className="space-y-2 text-sm text-emerald-900">
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="w-4 h-4 mt-0.5 text-emerald-600 shrink-0" />
                        Upgrade to Luxury Riverside Camps / Hotels.
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="w-4 h-4 mt-0.5 text-emerald-600 shrink-0" />
                        Add Bungee Jumping / Giant Swing.
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="w-4 h-4 mt-0.5 text-emerald-600 shrink-0" />
                        Extend trip to Mussoorie or Dehradun.
                      </li>
                    </ul>
              ...
              <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
                <div>
                  ...
                  <p className="text-slate-500 text-sm mt-1">
                    Balanced plan covering Spirituality, Adventure & Nature
                  </p>
                </div>
                <motion.button
            ...
            <ScrollReveal>
              <div className="space-y-4">
                <h3 className="text-xl sm:text-2xl font-bold flex items-center gap-2">
                  ...
                  Haridwar → Rishikesh → Shivpuri Route Map
                </h3>
                <RishikeshRouteMap />
              </div>
            </ScrollReveal>
                  ...
                  <div className="p-5 sm:p-6 space-y-3 bg-white">
                    <div className="space-y-3 mb-6">
                      ...
                      <div className="flex items-start gap-2 text-xs sm:text-sm text-slate-600">
                        <CheckCircle2 className="w-4 h-4 mt-0.5 text-emerald-500 shrink-0" />
                        <span>
                          <strong>Support:</strong> On-trip assistance during your Rishikesh stay.
                        </span>
                      </div>
                    </div>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 p-3 px-4 shadow-[0_-5px_15px_rgba(0,0,0,0.05)] z-50 flex items-center justify-between safe-area-bottom">
        <div className="flex flex-col">
          ...
          <span className="text-lg font-bold text-slate-900 flex items-center">
            <IndianRupee className="w-4 h-4" /> 9,499
          </span>
        </div>
