// src/pages/destinations/KasolManikaran.jsx
...
// Data specific to Kasol-Manikaran Trip
const tourDetailsData = [
  { icon: Hotel, label: "Accommodation", value: "3★ Hotel / Camps" },
  { icon: Utensils, label: "Meals", value: "Breakfast & Dinner" },
  { icon: Car, label: "Transportation", value: "Private Cab / Tempo" },
  { icon: Users, label: "Group Size", value: "Friends / Couples" },
  ...
  { icon: Tent, label: "Category", value: "Nature & Riverside" },
  { icon: PawPrint, label: "Pet Policy", value: "Allowed (Camps)" },
];
...
// ---------- EXISTING DATA (KASOL – MANIKARAN 4D/3N) ----------
...
const heroSlides = [
  {
    ...
    title: 'Kasol • Manikaran Family & Friends Trip',
    subtitle: 'Parvati Valley, Cafés & Hot Springs',
    days: '4 Days | 3 Nights',
  },
  {
    image:
      'https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?q=80&w=1600&auto=format&fit=crop',
    title: 'Kasol • Chalal Riverside Escape',
    subtitle: 'Short Treks • Chill Vibes • Nature',
    days: '4 Days | Customizable',
  },
  {
    image:
      'https://images.unsplash.com/photo-1513836279014-a89f7a76ae86?q=80&w=1600&auto=format&fit=crop',
    title: 'Parvati Valley Side Trip',
    subtitle: 'Mountains, Rivers & Peaceful Stays',
    days: '4 Days | 3 Nights',
  },
];
...
const exploreLocations = [
  {
    image:
      'https://i.pinimg.com/1200x/48/a2/ee/48a2ee7f5f90fa9f00413503effcad7c.jpg',
    title: 'Kasol Riverside & Cafés',
    days: 'Day 1',
  },
  {
    image:
      'https://i.pinimg.com/1200x/9a/be/ba/9abeba88c09c712a9fe0773cb7f7ab17.jpg',
    title: 'Chalal Short Trek & Forest Trail',
    days: 'Day 2',
  },
  {
    image:
      'https://i.pinimg.com/736x/0c/d0/cf/0cd0cf0dfe36408147a5c07e9b62afd9.jpg',
    title: 'Manikaran Sahib Gurudwara & Hot Springs',
    days: 'Day 3',
  },
  {
    image:
      'https://i.pinimg.com/736x/64/e6/9b/64e69b85854d85f208bf6c7b6efc5863.jpg',
    title: 'Parvati Valley Viewpoints / Tosh (Optional)',
    days: 'Day 4',
  },
];
...
const tourHighlights = [
  'Scenic drive to Kasol through Kullu & Parvati Valley side views.',
  'Evening stroll at Kasol riverside, Israeli cafés & local market.',
  'Short forest trek to Chalal village with Parvati river views.',
  'Excursion to Manikaran Sahib Gurudwara & natural hot springs.',
  'Option to add Tosh / Kheerganga trek on extra cost & time.',
  'Comfortable stays with breakfast & dinner included.',
  'Perfect balance of chill time, light trek & spiritual visit.',
];
...
const itinerary = [
  {
    day: 'Day 01',
    title: 'Arrival in Kasol – Parvati Riverside Vibes',
    description:
      'Drive to Kasol via hills & valley views, hotel check-in & evening at riverside cafés.',
    details:
      'Pickup from Delhi / Chandigarh / Bhuntar & drive towards Kasol via Kullu and Parvati Valley. Enjoy scenic river & mountain views enroute. On arrival at Kasol, check in to your hotel / camp. In the evening, explore Kasol market, riverside area and famous Israeli cafés. Dinner & overnight stay in Kasol.',
  },
  {
    day: 'Day 02',
    title: 'Kasol – Chalal Short Trek & Local Exploration',
    description:
      'Easy walk to Chalal village, forest trail, river viewpoints & café hopping.',
    details:
      'After breakfast, start for a short and easy trek / walk towards Chalal village through pine forest trails along Parvati river. Enjoy peaceful surroundings, photography points & small cafés enroute. Return to Kasol by afternoon. Evening free to relax, shop or enjoy bonfire (as per property). Dinner & overnight stay in Kasol.',
  },
  {
    day: 'Day 03',
    title: 'Kasol – Manikaran Sahib & Hot Springs',
    description:
      'Spiritual visit to Gurudwara Manikaran Sahib, temple & hot water springs.',
    details:
      'After breakfast, drive to Manikaran (approx 30–40 mins). Visit Gurudwara Manikaran Sahib, Shiva temple and experience the natural hot water springs. Have langar (community meal) if you wish. Later explore nearby Parvati valley viewpoints. Return to Kasol by evening. Time free for last-minute shopping & café visits. Dinner & overnight stay in Kasol.',
  },
  {
    day: 'Day 04',
    title: 'Optional Tosh / Kheerganga • Departure',
    description:
      'Option to do Tosh / Kheerganga (if planned) or relaxed departure from Kasol.',
    details:
      'After breakfast, check out from hotel. If you have pre-planned Tosh / Kheerganga extension, you can proceed accordingly (extra nights & trek charges apply). Otherwise, you start your return journey towards Delhi / Chandigarh / Bhuntar with beautiful memories of Kasol, Manikaran & Parvati Valley. Drop at your onward point. Tour ends.',
  },
];

// INCLUSIONS
const includeFeatures = [
  '3 Nights stay in hotel / camp in or near Kasol.',
  'Daily breakfast & dinner (as per meal plan).',
  'Pickup & drop from Delhi / Chandigarh / Bhuntar by private vehicle (as per package).',
  'Kasol, Chalal & Manikaran sightseeing by private cab.',
  'Driver night charges, toll taxes, parking & fuel included.',
  '24x7 basic trip assistance on call.',
];

// EXCLUSIONS
const excludeFeatures = [
  'Train / Flight / Volvo bus tickets to and from starting point.',
  'Lunch and meals not mentioned in inclusions.',
  'Trek charges for Tosh / Kheerganga, guide, equipment & camping.',
  'Entry tickets, personal shopping & any adventure activities.',
  'Room heater charges (if applicable at property).',
...
const faqs = [
  {
    question: 'Best time to visit Kasol & Manikaran?',
    answer:
      'Best time is October to June. March–June is ideal for pleasant weather, and winter months are colder but beautiful. Monsoon (Jul–Sep) me baarish thodi zyada ho sakti hai.',
  },
  {
    question: 'Is this 4-day Kasol–Manikaran trip family-friendly?',
    answer:
      'Haan, agar itinerary light rakho (Chalal easy trail + Manikaran visit) to families & kids bhi enjoy kar sakte hain. Tosh / Kheerganga trek more suitable for youngsters / fit travellers hai.',
  },
  {
    question: 'Kheerganga / Tosh trek iss package me include hai?',
    answer:
      'Nahi, base package me nahi. Tosh / Kheerganga trek optional add-on hai – extra cost & extra day/time ke saath customize kiya ja sakta hai.',
  },
];
...
const relevantPackages = [
  {
    image:
      'https://i.pinimg.com/736x/0c/d0/cf/0cd0cf0dfe36408147a5c07e9b62afd9.jpg',
    title: 'Kasol • Manikaran Short Escape',
    country: 'Parvati Valley, Himachal',
    days: '3 Days / 2 Nights',
    price: '₹8,499',
  },
  {
    image:
      'https://i.pinimg.com/1200x/9d/4f/9e/9d4f9ed2aafa0bafebbd25667d226a2c.jpg',
    title: 'Kasol • Tosh • Kheerganga Trek',
    country: 'Kasol Region, Himachal',
  ...
  },
  {
    image:
      'https://i.pinimg.com/736x/64/e6/9b/64e69b85854d85f208bf6c7b6efc5863.jpg',
    title: 'Parvati Valley Backpacker Special',
...
// ROUTE COORDS (approx) – Kasol → Chalal → Manikaran → Tosh
const routeCoords = [
  [32.0100, 77.3150], // Kasol
  [32.0158, 77.3290], // Chalal side approx
  [32.0276, 77.3516], // Manikaran
  [32.0266, 77.4550], // Tosh side approx
];

// ---------- SEPARATE ROUTE MAP COMPONENT ----------

function KasolRouteMap() {
...
export default function KasolManikaran() {
      ...
      <div className="bg-white shadow-md border-b border-slate-100 relative z-20 -mt-2 sm:mt-0 rounded-t-2xl sm:rounded-none">
        <div className="container mx-auto px-4 py-4 md:py-5 flex flex-wrap gap-x-6 gap-y-3 items-center justify-center lg:justify-between text-xs sm:text-sm md:text-base font-medium text-slate-700">
          ...
          <div className="flex items-center gap-2 bg-yellow-50 px-3 py-1 rounded-full">
            ...
            <span>
              4.8 / 5 based on <strong>250+ reviews</strong>
            </span>
          </div>
          <div className="hidden sm:flex items-center gap-2">
            <CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" />
            <span>Popular in Young Travellers & Groups</span>
          </div>
        </div>
      </div>
            ...
            <ScrollReveal>
              <div id="overview">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 text-slate-900">
                  About Kasol – Manikaran Tour (4 Days / 3 Nights)
                </h2>
                <p className="text-sm sm:text-base md:text-lg text-slate-600 mb-6 leading-relaxed">
                  Agar aapko{' '}
                  <span className="font-semibold text-blue-700">
                    chill vibes, riverside cafés, short treks aur Manikaran
                    Sahib jaise spiritual spot
                  </span>{' '}
                  ek hi trip me cover karne hain, toh yeh{' '}
                  <strong>Kasol – Chalal – Manikaran</strong> package perfect
                  hai. Young groups, couples aur light-adventure lovers ke liye
                  yeh trip best combination hai – scenic, relaxed & budget
                  friendly.
                </p>
                  ...
                  <div className="p-5 sm:p-6 space-y-4">
                    ...
                    <h3 className="text-xl sm:text-2xl font-bold text-emerald-950 leading-tight">
                      ...
                      <span className="block text-emerald-700 text-lg sm:text-xl mt-1">
                        Build your own Kasol – Parvati Trip
                      </span>
                    </h3>
                    <ul className="space-y-2 text-sm text-emerald-900">
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="w-4 h-4 mt-0.5 text-emerald-600 shrink-0" />
                        Upgrade to riverside stays or boutique stays.
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="w-4 h-4 mt-0.5 text-emerald-600 shrink-0" />
                        Add Tosh / Kheerganga trek with extra nights.
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="w-4 h-4 mt-0.5 text-emerald-600 shrink-0" />
                        Customize pick-up point (Delhi / Chandigarh / Bhuntar).
                      </li>
                    </ul>
              ...
              <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
                <div>
                  ...
                  <p className="text-slate-500 text-sm mt-1">
                    Chill + light adventure + spiritual experience in one plan
                  </p>
                </div>
                <motion.button
            ...
            <ScrollReveal>
              <div className="space-y-4">
                <h3 className="text-xl sm:text-2xl font-bold flex items-center gap-2">
                  ...
                  Kasol → Chalal → Manikaran → Tosh Route Map
                </h3>
                <KasolRouteMap />
              </div>
            </ScrollReveal>
